            ...
            <Container >
                <Row >
                    ...
                    <Col md={6} className="about-info-container">
                        ...
                        <p className="fs-5 text-muted">Hi! My name is Kamrul Hasan. I am an mern stack developer, having good knowledge on multiple core technologies like (HTML, CSS, Bootstrap, Tailwind CSS, Material UI, React, Node JS, Mongo DB, Firebase).</p>
                        <p>Find with me</p>
